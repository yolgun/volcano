...
if ! diff ${VK_ROOT}/installer/volcano-development.yaml ${RELEASE_FOLDER}/volcano-${TAG}.yaml ; then
	{
		echo
		echo "The Generated yaml is different from the one in installer/volcano-development.yaml"
		echo "please run 'make generate-yaml TAG=${TAG} RELEASE_DIR=installer \
